...
public class TextReplacementAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_HEADER) {
            View view = inflater.inflate(rkr.simplekeyboard.inputmethod.R.layout.item_text_replacement_header, parent, false);
            return new HeaderViewHolder(view);
        } else {
            View view = inflater.inflate(rkr.simplekeyboard.inputmethod.R.layout.item_text_replacement, parent, false);
    ...
    class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        ItemViewHolder(View itemView) {
            super(itemView);
            checkboxSelect = itemView.findViewById(rkr.simplekeyboard.inputmethod.R.id.checkbox_select);
            editMisspell = itemView.findViewById(rkr.simplekeyboard.inputmethod.R.id.edit_misspell);
            editCorrect = itemView.findViewById(rkr.simplekeyboard.inputmethod.R.id.edit_correct);
            switchAlwaysOn = itemView.findViewById(rkr.simplekeyboard.inputmethod.R.id.switch_always_on);
        }
