...
import com.gkohn11.spellcheckkeyboard.latin.AudioAndHapticFeedbackManager;
import com.gkohn11.spellcheckkeyboard.latin.InputAttributes;
...
public final class Settings extends BroadcastReceiver implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static boolean readLongPressForNumbers(final SharedPreferences prefs) {
        return prefs.getBoolean(PREF_LONG_PRESS_FOR_NUMBERS, true);
    }
